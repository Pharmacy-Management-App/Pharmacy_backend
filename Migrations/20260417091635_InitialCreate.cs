    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 17, 9, 16, 34, 562, DateTimeKind.Utc).AddTicks(2531), "Bacterial infection medicines", true, "Antibiotics" },
                    { 2, new DateTime(2026, 4, 17, 9, 16, 34, 562, DateTimeKind.Utc).AddTicks(2855), "Pain relief medicines", true, "Painkillers" },
                    { 3, new DateTime(2026, 4, 17, 9, 16, 34, 562, DateTimeKind.Utc).AddTicks(2857), "Vitamin supplements", true, "Vitamins" },
                    { 4, new DateTime(2026, 4, 17, 9, 16, 34, 562, DateTimeKind.Utc).AddTicks(2859), "Diabetes management", true, "Antidiabetics" },
                    { 5, new DateTime(2026, 4, 17, 9, 16, 34, 562, DateTimeKind.Utc).AddTicks(2861), "Heart & BP medicines", true, "Cardiovascular" }
                });
